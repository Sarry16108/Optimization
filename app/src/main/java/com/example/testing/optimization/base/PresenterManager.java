...
import com.example.testing.optimization.activities.MemberPubAct;
import com.example.testing.optimization.activities.StockDetailAct;
...
public class PresenterManager {
    ...
    //该次购买详情页
    public static void toStockDetail(BaseActivity activity, PersonalPub.FbbTodayItemListBean.StockItemInfo stockInfo, UserSimpleInfo personInfo) {
        Intent intent = new Intent(activity,StockDetailAct.class);
    ...
    //用户详情页
    public static void toPersonDetail(BaseActivity activity, UserSimpleInfo userInfo) {
        Intent intent = new Intent(activity,MemberPubAct.class);
